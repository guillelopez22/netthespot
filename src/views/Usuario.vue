    ...
    <div class="row">
      ...
      <div class="input-field col s6">
        <select
          ...
          v-on:input="usuario.scope = $event.target.value"
          type="text"
          v-model="usuario.scope"
          :disabled="loading"
          id="scope"
        >
  ...
  methods: {
    ...
    createUsuario() {
      ...
      if (
        ...
        sweetAlert(
          "Oops...",
          "El usuario debe tener por lo menos 3 caracteres ",
          "error"
        );
        ...
        sweetAlert(
          "Oops...",
          "El teléfono debe tener por lo menos 8 caracteres",
          "error"
        );
